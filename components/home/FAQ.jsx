...
export default function FAQ() {
  const qnas = [
    ...
    {
      title: "Does PoopUp work on mobile?",
      body: "Yes! To keep your visitor's experience smooth, only one PoopUp will be displayed at a time.",
    },
    {
      title: "What can I customize?",
      body: `Currently, you can customize these key elements <ul class="mt-2"><li>PoopUp title</li><li>PoopUp body</li><li>PoopUp Icon</li><li>When are PoopUps firing</li><li>How often are PoopUps firing</li><li>How long are PoopUps displayed</li></ul>`,
    },
  ];
  return (
